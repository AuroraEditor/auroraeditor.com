                ...
                <div className="section-content">
                    <div className="row">
                        <div className="column large-centered large-10 small-12">
                            ...
                            <h4 className="margin-top-small">Aurora Editor</h4>
                            ...
                            <h4 className="margin-top-small">Instruments</h4>
                            <ul className="compound-item-list">
                            ...
                            <h4 className="margin-top-small">Localization</h4>
                            <ul className="compound-item-list">
                                <li>Added Dutch localization.</li>
                                <li>Added Afrikaans localization.</li>
                            </ul>

                            <h4 className="margin-top-small">Source Control</h4>
                            <p>Added support for allowing users to use git with projects.</p>


                            <h4 className="margin-top-small">Previews</h4>
                            ...
                            <h4 className="margin-top-small">Source Editor</h4>
                            <ul className="compound-item-list">
                            ...
                            <h4 className="margin-top-small">Swift Packages</h4>
