            ...
            <div className="footer-content">
                <section className="footer-mini" vocab="http://schema.org/" typeof="Organization">
                    ...
                    <div className="footer-mini-legal">
                        <div className="footer-mini-legal-copyright">Copyright &copy; 2022 <a href="https://auroracompany.dev" target="_blank" rel="noopener">Aurora Company.</a> All rights reserved.</div>
